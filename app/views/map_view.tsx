                    ...
                    {visibleMarkers.map((marker, index) => (
                        ...
                        >
                            <Callout onPress={() => onCalloutSelected(marker)}>
                                <View style={map_view_styles.callout}>
                                    <Text style={map_view_styles.calloutText}>{marker.name}</Text>
                                    {renderRating(marker.rating, true)}
                                    <Text style={map_view_styles.calloutText}>Cliquez pour réserver !</Text>
                                </View>
                            </Callout>
                        </Marker>
                    ))}
